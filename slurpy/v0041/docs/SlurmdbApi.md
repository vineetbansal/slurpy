# slurpy.v0041.SlurmdbApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_account**](SlurmdbApi.md#delete_account) | **DELETE** /slurmdb/v0.0.41/account/{account_name} | Delete account
[**delete_association**](SlurmdbApi.md#delete_association) | **DELETE** /slurmdb/v0.0.41/association/ | Delete association
[**delete_associations**](SlurmdbApi.md#delete_associations) | **DELETE** /slurmdb/v0.0.41/associations/ | Delete associations
[**delete_cluster**](SlurmdbApi.md#delete_cluster) | **DELETE** /slurmdb/v0.0.41/cluster/{cluster_name} | Delete cluster
[**delete_single_qos**](SlurmdbApi.md#delete_single_qos) | **DELETE** /slurmdb/v0.0.41/qos/{qos} | Delete QOS
[**delete_user**](SlurmdbApi.md#delete_user) | **DELETE** /slurmdb/v0.0.41/user/{name} | Delete user
[**delete_wckey**](SlurmdbApi.md#delete_wckey) | **DELETE** /slurmdb/v0.0.41/wckey/{id} | Delete wckey
[**get_account**](SlurmdbApi.md#get_account) | **GET** /slurmdb/v0.0.41/account/{account_name} | Get account info
[**get_accounts**](SlurmdbApi.md#get_accounts) | **GET** /slurmdb/v0.0.41/accounts/ | Get account list
[**get_association**](SlurmdbApi.md#get_association) | **GET** /slurmdb/v0.0.41/association/ | Get association info
[**get_associations**](SlurmdbApi.md#get_associations) | **GET** /slurmdb/v0.0.41/associations/ | Get association list
[**get_cluster**](SlurmdbApi.md#get_cluster) | **GET** /slurmdb/v0.0.41/cluster/{cluster_name} | Get cluster info
[**get_clusters**](SlurmdbApi.md#get_clusters) | **GET** /slurmdb/v0.0.41/clusters/ | Get cluster list
[**get_config**](SlurmdbApi.md#get_config) | **GET** /slurmdb/v0.0.41/config | Dump all configuration information
[**get_diag**](SlurmdbApi.md#get_diag) | **GET** /slurmdb/v0.0.41/diag/ | Get slurmdb diagnostics
[**get_instance**](SlurmdbApi.md#get_instance) | **GET** /slurmdb/v0.0.41/instance/ | Get instance info
[**get_instances**](SlurmdbApi.md#get_instances) | **GET** /slurmdb/v0.0.41/instances/ | Get instance list
[**get_job**](SlurmdbApi.md#get_job) | **GET** /slurmdb/v0.0.41/job/{job_id} | Get job info
[**get_jobs**](SlurmdbApi.md#get_jobs) | **GET** /slurmdb/v0.0.41/jobs/ | Get job list
[**get_qos**](SlurmdbApi.md#get_qos) | **GET** /slurmdb/v0.0.41/qos/ | Get QOS list
[**get_single_qos**](SlurmdbApi.md#get_single_qos) | **GET** /slurmdb/v0.0.41/qos/{qos} | Get QOS info
[**get_tres**](SlurmdbApi.md#get_tres) | **GET** /slurmdb/v0.0.41/tres/ | Get TRES info
[**get_user**](SlurmdbApi.md#get_user) | **GET** /slurmdb/v0.0.41/user/{name} | Get user info
[**get_users**](SlurmdbApi.md#get_users) | **GET** /slurmdb/v0.0.41/users/ | Get user list
[**get_wckey**](SlurmdbApi.md#get_wckey) | **GET** /slurmdb/v0.0.41/wckey/{id} | Get wckey info
[**get_wckeys**](SlurmdbApi.md#get_wckeys) | **GET** /slurmdb/v0.0.41/wckeys/ | Get wckey list
[**post_accounts**](SlurmdbApi.md#post_accounts) | **POST** /slurmdb/v0.0.41/accounts/ | Add/update list of accounts
[**post_accounts_association**](SlurmdbApi.md#post_accounts_association) | **POST** /slurmdb/v0.0.41/accounts_association/ | Add accounts with conditional association
[**post_associations**](SlurmdbApi.md#post_associations) | **POST** /slurmdb/v0.0.41/associations/ | Set associations info
[**post_clusters**](SlurmdbApi.md#post_clusters) | **POST** /slurmdb/v0.0.41/clusters/ | Get cluster list
[**post_config**](SlurmdbApi.md#post_config) | **POST** /slurmdb/v0.0.41/config | Load all configuration information
[**post_qos**](SlurmdbApi.md#post_qos) | **POST** /slurmdb/v0.0.41/qos/ | Add or update QOSs
[**post_tres**](SlurmdbApi.md#post_tres) | **POST** /slurmdb/v0.0.41/tres/ | Add TRES
[**post_users**](SlurmdbApi.md#post_users) | **POST** /slurmdb/v0.0.41/users/ | Update users
[**post_users_association**](SlurmdbApi.md#post_users_association) | **POST** /slurmdb/v0.0.41/users_association/ | Add users with conditional association
[**post_wckeys**](SlurmdbApi.md#post_wckeys) | **POST** /slurmdb/v0.0.41/wckeys/ | Add or update wckeys
...
```python
import slurpy.v0041
from slurpy.v0041.models.open_api_accounts_removed_resp import OpenAPIAccountsRemovedResp
from slurpy.v0041.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = slurpy.v0041.Configuration(
    host = "http://localhost"
)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
...
```python
import slurpy.v0041
from slurpy.v0041.models.open_api_clusters_removed_resp import OpenAPIClustersRemovedResp
from slurpy.v0041.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0041
from slurpy.v0041.models.open_api_slurmdbd_qos_removed_resp import OpenAPISlurmdbdQosRemovedResp
from slurpy.v0041.rest import ApiException
from pprint import pprint
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    open_api_accounts_resp = slurpy.v0041.OpenAPIAccountsResp() # OpenAPIAccountsResp | Description of accounts to update/create (optional)
...
```python
import slurpy.v0041
from slurpy.v0041.models.open_api_accounts_add_cond_resp import OpenAPIAccountsAddCondResp
from slurpy.v0041.models.open_api_accounts_add_cond_resp_str import OpenAPIAccountsAddCondRespStr
from slurpy.v0041.rest import ApiException
from pprint import pprint
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    open_api_accounts_add_cond_resp = slurpy.v0041.OpenAPIAccountsAddCondResp() # OpenAPIAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    open_api_assocs_resp = slurpy.v0041.OpenAPIAssocsResp() # OpenAPIAssocsResp | Job description (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Filter reservations since update timestamp (optional)
    open_api_clusters_resp = slurpy.v0041.OpenAPIClustersResp() # OpenAPIClustersResp | Cluster add or update descriptions (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    open_api_slurmdbd_config_resp = slurpy.v0041.OpenAPISlurmdbdConfigResp() # OpenAPISlurmdbdConfigResp | Add or update config (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted QOS (optional)
    open_api_slurmdbd_qos_resp = slurpy.v0041.OpenAPISlurmdbdQosResp() # OpenAPISlurmdbdQosResp | Description of QOS to add or update (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    open_api_tres_resp = slurpy.v0041.OpenAPITresResp() # OpenAPITresResp | TRES descriptions. Only works in developer mode. (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmdbApi(api_client)
    open_api_users_resp = slurpy.v0041.OpenAPIUsersResp() # OpenAPIUsersResp | add or update user (optional)
...
from slurpy.v0041.models.open_api_users_add_cond_resp_str import OpenAPIUsersAddCondRespStr
from slurpy.v0041.rest import ApiException
from pprint import pprint
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    flags = 'flags_example' # str | Query flags (optional)
    open_api_users_add_cond_resp = slurpy.v0041.OpenAPIUsersAddCondResp() # OpenAPIUsersAddCondResp | Create users with conditional association (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted wckeys (optional)
    open_api_wckey_resp = slurpy.v0041.OpenAPIWckeyResp() # OpenAPIWckeyResp | wckeys description (optional)
