...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0041.SlurmApi(api_client)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmApi(api_client)
    kill_jobs_msg = slurpy.v0041.KillJobsMsg() # KillJobsMsg | Signal or cancel jobs (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0041.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    job_desc_msg = slurpy.v0041.JobDescMsg() # JobDescMsg | Job update description (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmApi(api_client)
    job_alloc_req = slurpy.v0041.JobAllocReq() # JobAllocReq | Job allocation description (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmApi(api_client)
    job_submit_req = slurpy.v0041.JobSubmitReq() # JobSubmitReq | Job description (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0041.SlurmApi(api_client)
    node_name = 'node_name_example' # str | Node name
    update_node_msg = slurpy.v0041.UpdateNodeMsg() # UpdateNodeMsg | Node update description (optional)
...
async with slurpy.v0041.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0041.SlurmApi(api_client)
    update_node_msg = slurpy.v0041.UpdateNodeMsg() # UpdateNodeMsg | Nodelist update description (optional)
