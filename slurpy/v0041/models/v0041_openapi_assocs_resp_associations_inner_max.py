...
class V0041OpenapiAssocsRespAssociationsInnerMax(BaseModel):
    """
    V0041OpenapiAssocsRespAssociationsInnerMax
    """  # noqa: E501

    jobs: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxJobs] = None
    tres: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxTres] = None
    per: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxPer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "jobs": V0041OpenapiAssocsRespAssociationsInnerMaxJobs.from_dict(
                    obj["jobs"]
                )
                if obj.get("jobs") is not None
                else None,
                "tres": V0041OpenapiAssocsRespAssociationsInnerMaxTres.from_dict(
                    obj["tres"]
                )
                if obj.get("tres") is not None
                else None,
                "per": V0041OpenapiAssocsRespAssociationsInnerMaxPer.from_dict(
                    obj["per"]
                )
