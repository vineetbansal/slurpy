...
class V0041OpenapiAssocsRespAssociationsInnerMaxJobsPer(BaseModel):
    """
    ...
    submitted: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerSubmitted] = (
        None
    )
    wall_clock: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerWallClock] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "submitted": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerSubmitted.from_dict(
                    obj["submitted"]
                )
                if obj.get("submitted") is not None
                else None,
                "wall_clock": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerWallClock.from_dict(
                    obj["wall_clock"]
                )
