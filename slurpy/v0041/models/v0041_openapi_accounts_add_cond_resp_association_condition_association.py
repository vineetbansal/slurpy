...
class V0041OpenapiAccountsAddCondRespAssociationConditionAssociation(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                "grpjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpjobs.from_dict(
                    obj["grpjobs"]
                )
                if obj.get("grpjobs") is not None
                else None,
                "grpjobsaccrue": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpjobsaccrue.from_dict(
                    obj["grpjobsaccrue"]
                )
                if obj.get("grpjobsaccrue") is not None
                else None,
                "grpsubmitjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpsubmitjobs.from_dict(
                    obj["grpsubmitjobs"]
                )
                ...
                "grpwall": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpwall.from_dict(
                    obj["grpwall"]
                )
                if obj.get("grpwall") is not None
                else None,
                "maxjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxjobs.from_dict(
                    obj["maxjobs"]
                )
                if obj.get("maxjobs") is not None
                else None,
                "maxjobsaccrue": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxjobsaccrue.from_dict(
                    obj["maxjobsaccrue"]
                )
                if obj.get("maxjobsaccrue") is not None
                else None,
                "maxsubmitjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxsubmitjobs.from_dict(
                    obj["maxsubmitjobs"]
                )
                ...
                "maxwalldurationperjob": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxwalldurationperjob.from_dict(
                    obj["maxwalldurationperjob"]
                )
                if obj.get("maxwalldurationperjob") is not None
                else None,
                "minpriothresh": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMinpriothresh.from_dict(
                    obj["minpriothresh"]
                )
                if obj.get("minpriothresh") is not None
                else None,
                "parent": obj.get("parent"),
                "priority": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationPriority.from_dict(
                    obj["priority"]
                )
