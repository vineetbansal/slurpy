...
class V0041OpenapiAccountsAddCondRespMetaSlurm(BaseModel):
    """
    V0041OpenapiAccountsAddCondRespMetaSlurm
    """  # noqa: E501

    version: Optional[V0041OpenapiAccountsAddCondRespMetaSlurmVersion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "version": V0041OpenapiAccountsAddCondRespMetaSlurmVersion.from_dict(
                    obj["version"]
                )
