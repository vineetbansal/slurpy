        ...
        _obj = cls.model_validate(
            {
                ...
                "default": V0041OpenapiAssocsRespAssociationsInnerDefault.from_dict(
                    obj["default"]
                )
                if obj.get("default") is not None
                else None,
                "flags": obj.get("flags"),
                "max": V0041OpenapiAssocsRespAssociationsInnerMax.from_dict(obj["max"])
                if obj.get("max") is not None
                else None,
                "id": obj.get("id"),
                "is_default": obj.get("is_default"),
                "lineage": obj.get("lineage"),
                "min": V0041OpenapiAssocsRespAssociationsInnerMin.from_dict(obj["min"])
