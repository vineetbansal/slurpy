...
from slurpy.v0041.models.v0041_openapi_users_resp_users_inner_associations_inner import (
    V0041OpenapiUsersRespUsersInnerAssociationsInner,
)
from slurpy.v0041.models.v0041_openapi_users_resp_users_inner_coordinators_inner import (
    V0041OpenapiUsersRespUsersInnerCoordinatorsInner,
)
...
class V0041OpenapiSlurmdbdConfigRespAccountsInner(BaseModel):
    ...
    associations: Optional[List[V0041OpenapiUsersRespUsersInnerAssociationsInner]] = (
        Field(
            default=None,
            description="Associations involving this account (only populated if requested)",
        )
    )
    coordinators: Optional[List[V0041OpenapiUsersRespUsersInnerCoordinatorsInner]] = (
        Field(
            default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "associations": [
                    V0041OpenapiUsersRespUsersInnerAssociationsInner.from_dict(_item)
                    for _item in obj["associations"]
                ]
                if obj.get("associations") is not None
                else None,
                "coordinators": [
                    V0041OpenapiUsersRespUsersInnerCoordinatorsInner.from_dict(_item)
