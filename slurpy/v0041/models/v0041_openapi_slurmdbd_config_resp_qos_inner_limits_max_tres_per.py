...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresPer(BaseModel):
    ...
    account: Optional[List[V0041OpenapiClustersRespClustersInnerTresInner]] = Field(
        default=None, description="MaxTRESPerAccount"
    )
    job: Optional[List[V0041OpenapiClustersRespClustersInnerTresInner]] = Field(
        default=None, description="MaxTRESPerJob"
    )
    node: Optional[List[V0041OpenapiClustersRespClustersInnerTresInner]] = Field(
        default=None, description="MaxTRESPerNode"
    )
    user: Optional[List[V0041OpenapiClustersRespClustersInnerTresInner]] = Field(
