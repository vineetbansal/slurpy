...
class V0041OpenapiInstancesRespInstancesInner(BaseModel):
    """
    ...
    time: Optional[V0041OpenapiInstancesRespInstancesInnerTime] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "time": V0041OpenapiInstancesRespInstancesInnerTime.from_dict(
                    obj["time"]
                )
