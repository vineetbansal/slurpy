...
class V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutes(BaseModel):
    """
    ...
    per: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "per": V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer.from_dict(
                    obj["per"]
                )
