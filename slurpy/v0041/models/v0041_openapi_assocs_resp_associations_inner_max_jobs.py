...
class V0041OpenapiAssocsRespAssociationsInnerMaxJobs(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "per": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPer.from_dict(
                    obj["per"]
                )
                if obj.get("per") is not None
                else None,
                "active": V0041OpenapiAssocsRespAssociationsInnerMaxJobsActive.from_dict(
                    obj["active"]
                )
                if obj.get("active") is not None
                else None,
                "accruing": V0041OpenapiAssocsRespAssociationsInnerMaxJobsAccruing.from_dict(
                    obj["accruing"]
                )
                if obj.get("accruing") is not None
                else None,
                "total": V0041OpenapiAssocsRespAssociationsInnerMaxJobsTotal.from_dict(
                    obj["total"]
                )
