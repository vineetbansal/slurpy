...
class V0041OpenapiAssocsRespAssociationsInnerMaxPerAccount(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "wall_clock": V0041OpenapiAssocsRespAssociationsInnerMaxPerAccountWallClock.from_dict(
                    obj["wall_clock"]
                )
