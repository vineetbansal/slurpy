...
class V0041OpenapiAssocsRespAssociationsInnerMaxPer(BaseModel):
    """
    V0041OpenapiAssocsRespAssociationsInnerMaxPer
    """  # noqa: E501

    account: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxPerAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "account": V0041OpenapiAssocsRespAssociationsInnerMaxPerAccount.from_dict(
                    obj["account"]
                )
