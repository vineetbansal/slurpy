...
class V0041OpenapiAssocsRespAssociationsInnerAccountingInner(BaseModel):
    """
    ...
    tres: Optional[V0041OpenapiAssocsRespAssociationsInnerAccountingInnerTRES] = Field(
        default=None, alias="TRES"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "allocated": V0041OpenapiAssocsRespAssociationsInnerAccountingInnerAllocated.from_dict(
                    obj["allocated"]
                )
                ...
                "id": obj.get("id"),
                "start": obj.get("start"),
                "TRES": V0041OpenapiAssocsRespAssociationsInnerAccountingInnerTRES.from_dict(
                    obj["TRES"]
                )
