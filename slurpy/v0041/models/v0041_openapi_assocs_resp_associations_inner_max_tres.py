...
class V0041OpenapiAssocsRespAssociationsInnerMaxTres(BaseModel):
    """
    ...
    group: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxTresGroup] = None
    minutes: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutes] = None
    per: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxTresPer] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "group": V0041OpenapiAssocsRespAssociationsInnerMaxTresGroup.from_dict(
                    obj["group"]
                )
                if obj.get("group") is not None
                else None,
                "minutes": V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutes.from_dict(
                    obj["minutes"]
                )
                if obj.get("minutes") is not None
                else None,
                "per": V0041OpenapiAssocsRespAssociationsInnerMaxTresPer.from_dict(
                    obj["per"]
                )
