...
class V0041OpenapiAccountsAddCondRespMeta(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "plugin": V0041OpenapiAccountsAddCondRespMetaPlugin.from_dict(
                    obj["plugin"]
                )
                if obj.get("plugin") is not None
                else None,
                "client": V0041OpenapiAccountsAddCondRespMetaClient.from_dict(
                    obj["client"]
                )
                if obj.get("client") is not None
                else None,
                "command": obj.get("command"),
                "slurm": V0041OpenapiAccountsAddCondRespMetaSlurm.from_dict(
                    obj["slurm"]
                )
