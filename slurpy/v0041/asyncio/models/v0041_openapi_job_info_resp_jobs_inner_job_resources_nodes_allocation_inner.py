        ...
        _obj = cls.model_validate(
            {
                "index": obj.get("index"),
                "name": obj.get("name"),
                "cpus": V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerCpus.from_dict(
                    obj["cpus"]
                )
                if obj.get("cpus") is not None
                else None,
                "memory": V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInnerMemory.from_dict(
                    obj["memory"]
                )
