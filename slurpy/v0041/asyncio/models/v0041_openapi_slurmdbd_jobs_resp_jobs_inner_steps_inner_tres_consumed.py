...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresConsumed(BaseModel):
    ...
    max: Optional[List[V0041OpenapiTresRespTRESInner]] = Field(
        default=None, description="Maximum TRES usage consumed among all tasks"
    )
    min: Optional[List[V0041OpenapiTresRespTRESInner]] = Field(
        default=None, description="Minimum TRES usage consumed among all tasks"
    )
    average: Optional[List[V0041OpenapiTresRespTRESInner]] = Field(
        default=None, description="Average TRES usage consumed among all tasks"
    )
    total: Optional[List[V0041OpenapiTresRespTRESInner]] = Field(
        default=None, description="Total TRES usage consumed among all tasks"
    )
