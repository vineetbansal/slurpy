...
class V0041OpenapiSlurmdbdStatsRespStatisticsRollups(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "hourly": V0041OpenapiSlurmdbdStatsRespStatisticsRollupsHourly.from_dict(
                    obj["hourly"]
                )
                if obj.get("hourly") is not None
                else None,
                "daily": V0041OpenapiSlurmdbdStatsRespStatisticsRollupsDaily.from_dict(
                    obj["daily"]
                )
                if obj.get("daily") is not None
                else None,
                "monthly": V0041OpenapiSlurmdbdStatsRespStatisticsRollupsMonthly.from_dict(
                    obj["monthly"]
                )
