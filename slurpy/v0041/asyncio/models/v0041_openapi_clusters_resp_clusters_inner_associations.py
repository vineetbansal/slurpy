...
class V0041OpenapiClustersRespClustersInnerAssociations(BaseModel):
    """
    V0041OpenapiClustersRespClustersInnerAssociations
    """  # noqa: E501

    root: Optional[V0041OpenapiClustersRespClustersInnerAssociationsRoot] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "root": V0041OpenapiClustersRespClustersInnerAssociationsRoot.from_dict(
                    obj["root"]
                )
