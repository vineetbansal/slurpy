...
class OpenAPIWckeyResp(BaseModel):
    ...
    wckeys: List[V0041OpenapiUsersRespUsersInnerWckeysInner] = Field(
        description="wckeys"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPIWckeyResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPIWckeyResp from a dict"""
        if obj is None:
            return None
