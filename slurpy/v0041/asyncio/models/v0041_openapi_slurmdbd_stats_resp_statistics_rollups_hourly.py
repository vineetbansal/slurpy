...
class V0041OpenapiSlurmdbdStatsRespStatisticsRollupsHourly(BaseModel):
    ...
    duration: Optional[V0041OpenapiSlurmdbdStatsRespStatisticsRollupsHourlyDuration] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "duration": V0041OpenapiSlurmdbdStatsRespStatisticsRollupsHourlyDuration.from_dict(
                    obj["duration"]
                )
