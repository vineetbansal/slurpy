...
class OpenAPITresResp(BaseModel):
    ...
    tres: List[V0041OpenapiTresRespTRESInner] = Field(description="TRES", alias="TRES")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPITresResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPITresResp from a dict"""
        if obj is None:
            return None
