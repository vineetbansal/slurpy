...
class OpenAPIAccountsResp(BaseModel):
    ...
    accounts: List[V0041OpenapiAccountsRespAccountsInner] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPIAccountsResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPIAccountsResp from a dict"""
        if obj is None:
            return None
