...
class V0041OpenapiPartitionRespPartitionsInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "nodes": V0041OpenapiPartitionRespPartitionsInnerNodes.from_dict(
                    obj["nodes"]
                )
                if obj.get("nodes") is not None
                else None,
                "accounts": V0041OpenapiPartitionRespPartitionsInnerAccounts.from_dict(
                    obj["accounts"]
                )
                if obj.get("accounts") is not None
                else None,
                "groups": V0041OpenapiPartitionRespPartitionsInnerGroups.from_dict(
                    obj["groups"]
                )
                if obj.get("groups") is not None
                else None,
                "qos": V0041OpenapiPartitionRespPartitionsInnerQos.from_dict(obj["qos"])
                if obj.get("qos") is not None
                else None,
                "alternate": obj.get("alternate"),
                "tres": V0041OpenapiPartitionRespPartitionsInnerTres.from_dict(
                    obj["tres"]
                )
                ...
                "cpus": V0041OpenapiPartitionRespPartitionsInnerCpus.from_dict(
                    obj["cpus"]
                )
                ...
                "minimums": V0041OpenapiPartitionRespPartitionsInnerMinimums.from_dict(
                    obj["minimums"]
                )
                ...
                "priority": V0041OpenapiPartitionRespPartitionsInnerPriority.from_dict(
                    obj["priority"]
                )
