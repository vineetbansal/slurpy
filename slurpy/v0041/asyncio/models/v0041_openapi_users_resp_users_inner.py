...
class V0041OpenapiUsersRespUsersInner(BaseModel):
    """
    ...
    default: Optional[V0041OpenapiUsersRespUsersInnerDefault] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0041OpenapiUsersRespUsersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0041OpenapiUsersRespUsersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "default": V0041OpenapiUsersRespUsersInnerDefault.from_dict(
                    obj["default"]
                )
