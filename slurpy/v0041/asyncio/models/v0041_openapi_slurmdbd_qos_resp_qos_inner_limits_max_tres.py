...
class V0041OpenapiSlurmdbdQosRespQosInnerLimitsMaxTres(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0041OpenapiSlurmdbdQosRespQosInnerLimitsMaxTres from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0041OpenapiSlurmdbdQosRespQosInnerLimitsMaxTres from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "minutes": V0041OpenapiSlurmdbdQosRespQosInnerLimitsMaxTresMinutes.from_dict(
                    obj["minutes"]
                )
                if obj.get("minutes") is not None
                else None,
                "per": V0041OpenapiSlurmdbdQosRespQosInnerLimitsMaxTresPer.from_dict(
                    obj["per"]
                )
