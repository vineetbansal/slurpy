...
class OpenAPISlurmdbdQosResp(BaseModel):
    ...
    qos: List[V0041OpenapiSlurmdbdQosRespQosInner] = Field(description="List of QOS")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPISlurmdbdQosResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPISlurmdbdQosResp from a dict"""
        if obj is None:
            return None
