...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatistics(BaseModel):
    ...
    cpu: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsCPU] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "CPU": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsCPU.from_dict(
                    obj["CPU"]
                )
