...
class OpenAPIUsersResp(BaseModel):
    ...
    users: List[V0041OpenapiUsersRespUsersInner] = Field(description="users")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPIUsersResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPIUsersResp from a dict"""
        if obj is None:
            return None
