...
class V0041OpenapiSlurmdbdStatsRespStatisticsRollupsDaily(BaseModel):
    ...
    duration: Optional[V0041OpenapiSlurmdbdStatsRespStatisticsRollupsDailyDuration] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "duration": V0041OpenapiSlurmdbdStatsRespStatisticsRollupsDailyDuration.from_dict(
                    obj["duration"]
                )
