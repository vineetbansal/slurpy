...
class OpenAPIAccountsAddCondResp(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPIAccountsAddCondResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPIAccountsAddCondResp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "association_condition": AccountsAddCond.from_dict(
                    obj["association_condition"]
                )
                if obj.get("association_condition") is not None
                else None,
                "account": AccountShort.from_dict(obj["account"])
