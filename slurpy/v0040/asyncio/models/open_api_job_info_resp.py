...
class OpenAPIJobInfoResp(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "jobs": [JobInfo.from_dict(_item) for _item in obj["jobs"]]
                if obj.get("jobs") is not None
                else None,
                "last_backfill": Uint64NoVal.from_dict(obj["last_backfill"])
                if obj.get("last_backfill") is not None
                else None,
                "last_update": Uint64NoVal.from_dict(obj["last_update"])
