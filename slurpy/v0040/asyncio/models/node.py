        ...
        _obj = cls.model_validate(
            {
                ...
                "boot_time": Uint64NoVal.from_dict(obj["boot_time"])
                ...
                "free_mem": Uint64NoVal.from_dict(obj["free_mem"])
                ...
                "last_busy": Uint64NoVal.from_dict(obj["last_busy"])
                ...
                "reason_changed_at": Uint64NoVal.from_dict(obj["reason_changed_at"])
                if obj.get("reason_changed_at") is not None
                else None,
                "reason_set_by_user": obj.get("reason_set_by_user"),
                "resume_after": Uint64NoVal.from_dict(obj["resume_after"])
                ...
                "slurmd_start_time": Uint64NoVal.from_dict(obj["slurmd_start_time"])
