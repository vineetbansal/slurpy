        ...
        _obj = cls.model_validate(
            {
                ...
                "system": V0040JobTimeSystem.from_dict(obj["system"])
                if obj.get("system") is not None
                else None,
                "limit": Uint32NoVal.from_dict(obj["limit"])
                if obj.get("limit") is not None
                else None,
                "total": V0040JobTimeTotal.from_dict(obj["total"])
                if obj.get("total") is not None
                else None,
                "user": V0040JobTimeUser.from_dict(obj["user"])
