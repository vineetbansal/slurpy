...
class JobSubmitReq(BaseModel):
    ...
    jobs: Optional[List[JobDescMsg]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobSubmitReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobSubmitReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "jobs": [JobDescMsg.from_dict(_item) for _item in obj["jobs"]]
