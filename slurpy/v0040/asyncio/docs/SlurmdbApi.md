# slurpy.v0040.asyncio.SlurmdbApi
...
from slurpy.v0040.asyncio.models.open_api_accounts_removed_resp import OpenAPIAccountsRemovedResp
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_assocs_removed_resp import OpenAPIAssocsRemovedResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_clusters_removed_resp import OpenAPIClustersRemovedResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_slurmdbd_qos_removed_resp import OpenAPISlurmdbdQosRemovedResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_wckey_removed_resp import OpenAPIWckeyRemovedResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_accounts_resp import OpenAPIAccountsResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_assocs_resp import OpenAPIAssocsResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_clusters_resp import OpenAPIClustersResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_slurmdbd_config_resp import OpenAPISlurmdbdConfigResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_slurmdbd_stats_resp import OpenAPISlurmdbdStatsResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_instances_resp import OpenAPIInstancesResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_slurmdbd_jobs_resp import OpenAPISlurmdbdJobsResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_slurmdbd_qos_resp import OpenAPISlurmdbdQosResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_tres_resp import OpenAPITresResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_users_resp import OpenAPIUsersResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_wckey_resp import OpenAPIWckeyResp
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    open_api_accounts_resp = slurpy.v0040.asyncio.OpenAPIAccountsResp() # OpenAPIAccountsResp | Description of accounts to update/create (optional)
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_accounts_add_cond_resp import OpenAPIAccountsAddCondResp
from slurpy.v0040.asyncio.models.open_api_accounts_add_cond_resp_str import OpenAPIAccountsAddCondRespStr
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    open_api_accounts_add_cond_resp = slurpy.v0040.asyncio.OpenAPIAccountsAddCondResp() # OpenAPIAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    open_api_assocs_resp = slurpy.v0040.asyncio.OpenAPIAssocsResp() # OpenAPIAssocsResp | Job description (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Filter reservations since update timestamp (optional)
    open_api_clusters_resp = slurpy.v0040.asyncio.OpenAPIClustersResp() # OpenAPIClustersResp | Cluster add or update descriptions (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    open_api_slurmdbd_config_resp = slurpy.v0040.asyncio.OpenAPISlurmdbdConfigResp() # OpenAPISlurmdbdConfigResp | Add or update config (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    ...
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted QOS (optional)
    open_api_slurmdbd_qos_resp = slurpy.v0040.asyncio.OpenAPISlurmdbdQosResp() # OpenAPISlurmdbdQosResp | Description of QOS to add or update (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    open_api_tres_resp = slurpy.v0040.asyncio.OpenAPITresResp() # OpenAPITresResp | TRES descriptions. Only works in developer mode. (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0040.asyncio.SlurmdbApi(api_client)
    open_api_users_resp = slurpy.v0040.asyncio.OpenAPIUsersResp() # OpenAPIUsersResp | add or update user (optional)
...
```python
import slurpy.v0040.asyncio
from slurpy.v0040.asyncio.models.open_api_users_add_cond_resp import OpenAPIUsersAddCondResp
from slurpy.v0040.asyncio.models.open_api_users_add_cond_resp_str import OpenAPIUsersAddCondRespStr
from slurpy.v0040.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    ...
    flags = 'flags_example' # str | Query flags (optional)
    open_api_users_add_cond_resp = slurpy.v0040.asyncio.OpenAPIUsersAddCondResp() # OpenAPIUsersAddCondResp | Create users with conditional association (optional)
...
async with slurpy.v0040.asyncio.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted wckeys (optional)
    open_api_wckey_resp = slurpy.v0040.asyncio.OpenAPIWckeyResp() # OpenAPIWckeyResp | wckeys description (optional)
