        ...
        _obj = cls.model_validate(
            {
                ...
                "grpjobs": Uint32NoVal.from_dict(obj["grpjobs"])
                if obj.get("grpjobs") is not None
                else None,
                "grpjobsaccrue": Uint32NoVal.from_dict(obj["grpjobsaccrue"])
                if obj.get("grpjobsaccrue") is not None
                else None,
                "grpsubmitjobs": Uint32NoVal.from_dict(obj["grpsubmitjobs"])
                ...
                "grpwall": Uint32NoVal.from_dict(obj["grpwall"])
                if obj.get("grpwall") is not None
                else None,
                "maxjobs": Uint32NoVal.from_dict(obj["maxjobs"])
                if obj.get("maxjobs") is not None
                else None,
                "maxjobsaccrue": Uint32NoVal.from_dict(obj["maxjobsaccrue"])
                if obj.get("maxjobsaccrue") is not None
                else None,
                "maxsubmitjobs": Uint32NoVal.from_dict(obj["maxsubmitjobs"])
                ...
                "maxwalldurationperjob": Uint32NoVal.from_dict(
                    obj["maxwalldurationperjob"]
                )
                if obj.get("maxwalldurationperjob") is not None
                else None,
                "minpriothresh": Uint32NoVal.from_dict(obj["minpriothresh"])
