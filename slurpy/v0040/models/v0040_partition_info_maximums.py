...
class V0040PartitionInfoMaximums(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "cpus_per_node": Uint32NoVal.from_dict(obj["cpus_per_node"])
                if obj.get("cpus_per_node") is not None
                else None,
                "cpus_per_socket": Uint32NoVal.from_dict(obj["cpus_per_socket"])
                ...
                "nodes": Uint32NoVal.from_dict(obj["nodes"])
                ...
                "over_time_limit": Uint16NoVal.from_dict(obj["over_time_limit"])
