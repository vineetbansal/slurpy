...
class V0042AssocMaxJobsPer(BaseModel):
    ...
    count: Optional[Uint32NoValStruct] = None
    accruing: Optional[Uint32NoValStruct] = None
    submitted: Optional[Uint32NoValStruct] = None
    wall_clock: Optional[Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "count": Uint32NoValStruct.from_dict(obj["count"])
                if obj.get("count") is not None
                else None,
                "accruing": Uint32NoValStruct.from_dict(obj["accruing"])
                if obj.get("accruing") is not None
                else None,
                "submitted": Uint32NoValStruct.from_dict(obj["submitted"])
                if obj.get("submitted") is not None
                else None,
                "wall_clock": Uint32NoValStruct.from_dict(obj["wall_clock"])
