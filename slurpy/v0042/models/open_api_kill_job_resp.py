...
class OpenAPIKillJobResp(BaseModel):
    ...
    status: List[KillJobsRespJob] = Field(description="List of jobs signal responses")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPIKillJobResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPIKillJobResp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "status": [KillJobsRespJob.from_dict(_item) for _item in obj["status"]]
