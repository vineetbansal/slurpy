...
class V0042JobDescMsgRlimits(BaseModel):
    ...
    cpu: Optional[Uint64NoValStruct] = None
    fsize: Optional[Uint64NoValStruct] = None
    data: Optional[Uint64NoValStruct] = None
    stack: Optional[Uint64NoValStruct] = None
    core: Optional[Uint64NoValStruct] = None
    rss: Optional[Uint64NoValStruct] = None
    nproc: Optional[Uint64NoValStruct] = None
    nofile: Optional[Uint64NoValStruct] = None
    memlock: Optional[Uint64NoValStruct] = None
    var_as: Optional[Uint64NoValStruct] = Field(default=None, alias="as")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "cpu": Uint64NoValStruct.from_dict(obj["cpu"])
                if obj.get("cpu") is not None
                else None,
                "fsize": Uint64NoValStruct.from_dict(obj["fsize"])
                if obj.get("fsize") is not None
                else None,
                "data": Uint64NoValStruct.from_dict(obj["data"])
                if obj.get("data") is not None
                else None,
                "stack": Uint64NoValStruct.from_dict(obj["stack"])
                if obj.get("stack") is not None
                else None,
                "core": Uint64NoValStruct.from_dict(obj["core"])
                if obj.get("core") is not None
                else None,
                "rss": Uint64NoValStruct.from_dict(obj["rss"])
                if obj.get("rss") is not None
                else None,
                "nproc": Uint64NoValStruct.from_dict(obj["nproc"])
                if obj.get("nproc") is not None
                else None,
                "nofile": Uint64NoValStruct.from_dict(obj["nofile"])
                if obj.get("nofile") is not None
                else None,
                "memlock": Uint64NoValStruct.from_dict(obj["memlock"])
                if obj.get("memlock") is not None
                else None,
                "as": Uint64NoValStruct.from_dict(obj["as"])
