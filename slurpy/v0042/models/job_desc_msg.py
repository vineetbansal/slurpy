...
class JobDescMsg(BaseModel):
    ...
    begin_time: Optional[Uint64NoValStruct] = None
    ...
    distribution_plane_size: Optional[Uint16NoValStruct] = None
    ...
    kill_warning_delay: Optional[Uint16NoValStruct] = None
    ...
    required_switches: Optional[Uint32NoValStruct] = None
    segment_size: Optional[Uint16NoValStruct] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "begin_time": Uint64NoValStruct.from_dict(obj["begin_time"])
                ...
                "crontab": CronEntry.from_dict(obj["crontab"])
                ...
                "distribution_plane_size": Uint16NoValStruct.from_dict(
                ...
                "kill_warning_delay": Uint16NoValStruct.from_dict(
                ...
                "required_switches": Uint32NoValStruct.from_dict(
                    obj["required_switches"]
                )
                if obj.get("required_switches") is not None
                else None,
                "segment_size": Uint16NoValStruct.from_dict(obj["segment_size"])
