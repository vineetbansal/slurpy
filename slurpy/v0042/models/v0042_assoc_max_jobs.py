...
class V0042AssocMaxJobs(BaseModel):
    ...
    active: Optional[Uint32NoValStruct] = None
    accruing: Optional[Uint32NoValStruct] = None
    total: Optional[Uint32NoValStruct] = None
