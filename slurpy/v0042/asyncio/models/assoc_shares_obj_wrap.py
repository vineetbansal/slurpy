...
class AssocSharesObjWrap(BaseModel):
    ...
    shares_normalized: Optional[Float64NoValStruct] = None
    shares: Optional[Uint32NoValStruct] = None
    tres: Optional[V0042AssocSharesObjWrapTres] = None
    effective_usage: Optional[Float64NoValStruct] = None
    usage_normalized: Optional[Float64NoValStruct] = None
