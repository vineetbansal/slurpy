...
class V0042AssocMaxTresGroup(BaseModel):
    ...
    minutes: Optional[List[Tres]] = None
    active: Optional[List[Tres]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "minutes": [Tres.from_dict(_item) for _item in obj["minutes"]]
                if obj.get("minutes") is not None
                else None,
                "active": [Tres.from_dict(_item) for _item in obj["active"]]
