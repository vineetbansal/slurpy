...
class V0042QosLimitsMaxJobsActiveJobsPer(BaseModel):
    ...
    account: Optional[Uint32NoValStruct] = None
    user: Optional[Uint32NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "account": Uint32NoValStruct.from_dict(obj["account"])
                if obj.get("account") is not None
                else None,
                "user": Uint32NoValStruct.from_dict(obj["user"])
