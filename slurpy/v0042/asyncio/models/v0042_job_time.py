...
class V0042JobTime(BaseModel):
    ...
    planned: Optional[Uint64NoValStruct] = None
    ...
    limit: Optional[Uint32NoValStruct] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "end": obj.get("end"),
                "planned": Uint64NoValStruct.from_dict(obj["planned"])
                ...
                "limit": Uint32NoValStruct.from_dict(obj["limit"])
