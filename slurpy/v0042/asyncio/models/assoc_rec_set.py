...
class AssocRecSet(BaseModel):
    ...
    grpjobs: Optional[Uint32NoValStruct] = None
    grpjobsaccrue: Optional[Uint32NoValStruct] = None
    grpsubmitjobs: Optional[Uint32NoValStruct] = None
    grptres: Optional[List[Tres]] = None
    grptresmins: Optional[List[Tres]] = None
    grptresrunmins: Optional[List[Tres]] = None
    grpwall: Optional[Uint32NoValStruct] = None
    maxjobs: Optional[Uint32NoValStruct] = None
    maxjobsaccrue: Optional[Uint32NoValStruct] = None
    maxsubmitjobs: Optional[Uint32NoValStruct] = None
    maxtresminsperjob: Optional[List[Tres]] = None
    maxtresrunmins: Optional[List[Tres]] = None
    maxtresperjob: Optional[List[Tres]] = None
    maxtrespernode: Optional[List[Tres]] = None
    maxwalldurationperjob: Optional[Uint32NoValStruct] = None
    minpriothresh: Optional[Uint32NoValStruct] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssocRecSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssocRecSet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "grpjobs": Uint32NoValStruct.from_dict(obj["grpjobs"])
                if obj.get("grpjobs") is not None
                else None,
                "grpjobsaccrue": Uint32NoValStruct.from_dict(obj["grpjobsaccrue"])
                if obj.get("grpjobsaccrue") is not None
                else None,
                "grpsubmitjobs": Uint32NoValStruct.from_dict(obj["grpsubmitjobs"])
                if obj.get("grpsubmitjobs") is not None
                else None,
                "grptres": [Tres.from_dict(_item) for _item in obj["grptres"]]
                if obj.get("grptres") is not None
                else None,
                "grptresmins": [Tres.from_dict(_item) for _item in obj["grptresmins"]]
                if obj.get("grptresmins") is not None
                else None,
                "grptresrunmins": [
                    Tres.from_dict(_item) for _item in obj["grptresrunmins"]
                ]
                if obj.get("grptresrunmins") is not None
                else None,
                "grpwall": Uint32NoValStruct.from_dict(obj["grpwall"])
                if obj.get("grpwall") is not None
                else None,
                "maxjobs": Uint32NoValStruct.from_dict(obj["maxjobs"])
                if obj.get("maxjobs") is not None
                else None,
                "maxjobsaccrue": Uint32NoValStruct.from_dict(obj["maxjobsaccrue"])
                if obj.get("maxjobsaccrue") is not None
                else None,
                "maxsubmitjobs": Uint32NoValStruct.from_dict(obj["maxsubmitjobs"])
                if obj.get("maxsubmitjobs") is not None
                else None,
                "maxtresminsperjob": [
                    Tres.from_dict(_item) for _item in obj["maxtresminsperjob"]
                ]
                if obj.get("maxtresminsperjob") is not None
                else None,
                "maxtresrunmins": [
                    Tres.from_dict(_item) for _item in obj["maxtresrunmins"]
                ]
                if obj.get("maxtresrunmins") is not None
                else None,
                "maxtresperjob": [
                    Tres.from_dict(_item) for _item in obj["maxtresperjob"]
                ]
                if obj.get("maxtresperjob") is not None
                else None,
                "maxtrespernode": [
                    Tres.from_dict(_item) for _item in obj["maxtrespernode"]
                ]
                if obj.get("maxtrespernode") is not None
                else None,
                "maxwalldurationperjob": Uint32NoValStruct.from_dict(
                    obj["maxwalldurationperjob"]
                )
                if obj.get("maxwalldurationperjob") is not None
                else None,
                "minpriothresh": Uint32NoValStruct.from_dict(obj["minpriothresh"])
