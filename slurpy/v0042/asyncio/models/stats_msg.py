...
class StatsMsg(BaseModel):
    ...
    req_time: Optional[Uint64NoValStruct] = None
    req_time_start: Optional[Uint64NoValStruct] = None
    ...
    job_states_ts: Optional[Uint64NoValStruct] = None
    ...
    bf_when_last_cycle: Optional[Uint64NoValStruct] = None
    bf_active: Optional[StrictBool] = Field(
        default=None, description="Backfill scheduler currently running"
    )
    rpcs_by_message_type: Optional[List[StatsMsgRpcType]] = Field(
        default=None, description="RPCs by type"
    )
    rpcs_by_user: Optional[List[StatsMsgRpcUser]] = Field(
        default=None, description="RPCs by user"
    )
    pending_rpcs: Optional[List[StatsMsgRpcQueue]] = Field(
        default=None, description="Pending RPCs"
    )
    pending_rpcs_by_hostlist: Optional[List[StatsMsgRpcDump]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "req_time": Uint64NoValStruct.from_dict(obj["req_time"])
                if obj.get("req_time") is not None
                else None,
                "req_time_start": Uint64NoValStruct.from_dict(obj["req_time_start"])
                ...
                "job_states_ts": Uint64NoValStruct.from_dict(obj["job_states_ts"])
                ...
                "bf_when_last_cycle": Uint64NoValStruct.from_dict(
                ...
                "rpcs_by_message_type": [
                    StatsMsgRpcType.from_dict(_item)
                    for _item in obj["rpcs_by_message_type"]
                ]
                if obj.get("rpcs_by_message_type") is not None
                else None,
                "rpcs_by_user": [
                    StatsMsgRpcUser.from_dict(_item) for _item in obj["rpcs_by_user"]
                ]
                if obj.get("rpcs_by_user") is not None
                else None,
                "pending_rpcs": [
                    StatsMsgRpcQueue.from_dict(_item) for _item in obj["pending_rpcs"]
                ]
                if obj.get("pending_rpcs") is not None
                else None,
                "pending_rpcs_by_hostlist": [
                    StatsMsgRpcDump.from_dict(_item)
