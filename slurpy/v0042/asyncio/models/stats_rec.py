...
class StatsRec(BaseModel):
    ...
    rpcs: Optional[List[StatsRpc]] = Field(default=None, alias="RPCs")
    users: Optional[List[StatsUser]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatsRec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatsRec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "rollups": RollupStats.from_dict(obj["rollups"])
                if obj.get("rollups") is not None
                else None,
                "RPCs": [StatsRpc.from_dict(_item) for _item in obj["RPCs"]]
                if obj.get("RPCs") is not None
                else None,
                "users": [StatsUser.from_dict(_item) for _item in obj["users"]]
