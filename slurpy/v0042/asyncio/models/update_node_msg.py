...
class UpdateNodeMsg(BaseModel):
    ...
    resume_after: Optional[Uint32NoValStruct] = None
    weight: Optional[Uint32NoValStruct] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "resume_after": Uint32NoValStruct.from_dict(obj["resume_after"])
                if obj.get("resume_after") is not None
                else None,
                "weight": Uint32NoValStruct.from_dict(obj["weight"])
