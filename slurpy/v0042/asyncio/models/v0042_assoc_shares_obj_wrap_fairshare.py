...
class V0042AssocSharesObjWrapFairshare(BaseModel):
    ...
    factor: Optional[Float64NoValStruct] = None
    level: Optional[Float64NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "factor": Float64NoValStruct.from_dict(obj["factor"])
                if obj.get("factor") is not None
                else None,
                "level": Float64NoValStruct.from_dict(obj["level"])
