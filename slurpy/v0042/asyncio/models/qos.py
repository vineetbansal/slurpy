...
class Qos(BaseModel):
    ...
    usage_factor: Optional[Float64NoValStruct] = None
    usage_threshold: Optional[Float64NoValStruct] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "usage_factor": Float64NoValStruct.from_dict(obj["usage_factor"])
                if obj.get("usage_factor") is not None
                else None,
                "usage_threshold": Float64NoValStruct.from_dict(obj["usage_threshold"])
