...
class ProcessExitCodeVerbose(BaseModel):
    ...
    return_code: Optional[Uint32NoValStruct] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProcessExitCodeVerbose from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProcessExitCodeVerbose from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "return_code": Uint32NoValStruct.from_dict(obj["return_code"])
