...
class V0042PartitionInfoTimeouts(BaseModel):
    ...
    resume: Optional[Uint16NoValStruct] = None
    suspend: Optional[Uint16NoValStruct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "resume": Uint16NoValStruct.from_dict(obj["resume"])
                if obj.get("resume") is not None
                else None,
                "suspend": Uint16NoValStruct.from_dict(obj["suspend"])
