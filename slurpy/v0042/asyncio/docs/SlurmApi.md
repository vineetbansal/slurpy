...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
    kill_jobs_msg = slurpy.v0042.asyncio.KillJobsMsg() # KillJobsMsg | Signal or cancel jobs (optional)
...
from slurpy.v0042.asyncio.models.open_api_job_post_response import OpenAPIJobPostResponse
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    job_desc_msg = slurpy.v0042.asyncio.JobDescMsg() # JobDescMsg | Job update description (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
    job_alloc_req = slurpy.v0042.asyncio.JobAllocReq() # JobAllocReq | Job allocation description (optional)
...
from slurpy.v0042.asyncio.models.open_api_job_submit_response import OpenAPIJobSubmitResponse
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
    job_submit_req = slurpy.v0042.asyncio.JobSubmitReq() # JobSubmitReq | Job description (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
    node_name = 'node_name_example' # str | Node name
    update_node_msg = slurpy.v0042.asyncio.UpdateNodeMsg() # UpdateNodeMsg | Node update description (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmApi(api_client)
    update_node_msg = slurpy.v0042.asyncio.UpdateNodeMsg() # UpdateNodeMsg | Nodelist update description (optional)
