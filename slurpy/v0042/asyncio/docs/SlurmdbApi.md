# slurpy.v0042.asyncio.SlurmdbApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**delete_account**](SlurmdbApi.md#delete_account) | **DELETE** /slurmdb/v0.0.42/account/{account_name} | Delete account
[**delete_association**](SlurmdbApi.md#delete_association) | **DELETE** /slurmdb/v0.0.42/association/ | Delete association
[**delete_associations**](SlurmdbApi.md#delete_associations) | **DELETE** /slurmdb/v0.0.42/associations/ | Delete associations
[**delete_cluster**](SlurmdbApi.md#delete_cluster) | **DELETE** /slurmdb/v0.0.42/cluster/{cluster_name} | Delete cluster
[**delete_single_qos**](SlurmdbApi.md#delete_single_qos) | **DELETE** /slurmdb/v0.0.42/qos/{qos} | Delete QOS
[**delete_user**](SlurmdbApi.md#delete_user) | **DELETE** /slurmdb/v0.0.42/user/{name} | Delete user
[**delete_wckey**](SlurmdbApi.md#delete_wckey) | **DELETE** /slurmdb/v0.0.42/wckey/{id} | Delete wckey
[**get_account**](SlurmdbApi.md#get_account) | **GET** /slurmdb/v0.0.42/account/{account_name} | Get account info
[**get_accounts**](SlurmdbApi.md#get_accounts) | **GET** /slurmdb/v0.0.42/accounts/ | Get account list
[**get_association**](SlurmdbApi.md#get_association) | **GET** /slurmdb/v0.0.42/association/ | Get association info
[**get_associations**](SlurmdbApi.md#get_associations) | **GET** /slurmdb/v0.0.42/associations/ | Get association list
[**get_cluster**](SlurmdbApi.md#get_cluster) | **GET** /slurmdb/v0.0.42/cluster/{cluster_name} | Get cluster info
[**get_clusters**](SlurmdbApi.md#get_clusters) | **GET** /slurmdb/v0.0.42/clusters/ | Get cluster list
[**get_config**](SlurmdbApi.md#get_config) | **GET** /slurmdb/v0.0.42/config | Dump all configuration information
[**get_diag**](SlurmdbApi.md#get_diag) | **GET** /slurmdb/v0.0.42/diag/ | Get slurmdb diagnostics
[**get_instance**](SlurmdbApi.md#get_instance) | **GET** /slurmdb/v0.0.42/instance/ | Get instance info
[**get_instances**](SlurmdbApi.md#get_instances) | **GET** /slurmdb/v0.0.42/instances/ | Get instance list
[**get_job**](SlurmdbApi.md#get_job) | **GET** /slurmdb/v0.0.42/job/{job_id} | Get job info
[**get_jobs**](SlurmdbApi.md#get_jobs) | **GET** /slurmdb/v0.0.42/jobs/ | Get job list
[**get_ping**](SlurmdbApi.md#get_ping) | **GET** /slurmdb/v0.0.42/ping/ | ping test
[**get_qos**](SlurmdbApi.md#get_qos) | **GET** /slurmdb/v0.0.42/qos/ | Get QOS list
[**get_single_qos**](SlurmdbApi.md#get_single_qos) | **GET** /slurmdb/v0.0.42/qos/{qos} | Get QOS info
[**get_tres**](SlurmdbApi.md#get_tres) | **GET** /slurmdb/v0.0.42/tres/ | Get TRES info
[**get_user**](SlurmdbApi.md#get_user) | **GET** /slurmdb/v0.0.42/user/{name} | Get user info
[**get_users**](SlurmdbApi.md#get_users) | **GET** /slurmdb/v0.0.42/users/ | Get user list
[**get_wckey**](SlurmdbApi.md#get_wckey) | **GET** /slurmdb/v0.0.42/wckey/{id} | Get wckey info
[**get_wckeys**](SlurmdbApi.md#get_wckeys) | **GET** /slurmdb/v0.0.42/wckeys/ | Get wckey list
[**post_accounts**](SlurmdbApi.md#post_accounts) | **POST** /slurmdb/v0.0.42/accounts/ | Add/update list of accounts
[**post_accounts_association**](SlurmdbApi.md#post_accounts_association) | **POST** /slurmdb/v0.0.42/accounts_association/ | Add accounts with conditional association
[**post_associations**](SlurmdbApi.md#post_associations) | **POST** /slurmdb/v0.0.42/associations/ | Set associations info
[**post_clusters**](SlurmdbApi.md#post_clusters) | **POST** /slurmdb/v0.0.42/clusters/ | Get cluster list
[**post_config**](SlurmdbApi.md#post_config) | **POST** /slurmdb/v0.0.42/config | Load all configuration information
[**post_qos**](SlurmdbApi.md#post_qos) | **POST** /slurmdb/v0.0.42/qos/ | Add or update QOSs
[**post_tres**](SlurmdbApi.md#post_tres) | **POST** /slurmdb/v0.0.42/tres/ | Add TRES
[**post_users**](SlurmdbApi.md#post_users) | **POST** /slurmdb/v0.0.42/users/ | Update users
[**post_users_association**](SlurmdbApi.md#post_users_association) | **POST** /slurmdb/v0.0.42/users_association/ | Add users with conditional association
[**post_wckeys**](SlurmdbApi.md#post_wckeys) | **POST** /slurmdb/v0.0.42/wckeys/ | Add or update wckeys
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_accounts_removed_resp import OpenAPIAccountsRemovedResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = slurpy.v0042.asyncio.Configuration(
    host = "http://localhost"
)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_assocs_removed_resp import OpenAPIAssocsRemovedResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
# **delete_associations**
> OpenAPIAssocsRemovedResp delete_associations(account=account, cluster=cluster, default_qos=default_qos, include_deleted_associations=include_deleted_associations, include_usage=include_usage, filter_to_only_defaults=filter_to_only_defaults, include_the_raw_qos_or_delta_qos=include_the_raw_qos_or_delta_qos, include_sub_acct_information=include_sub_acct_information, exclude_parent_id_name=exclude_parent_id_name, exclude_limits_from_parents=exclude_limits_from_parents, format=format, id=id, parent_account=parent_account, partition=partition, qos=qos, usage_end=usage_end, usage_start=usage_start, user=user)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete associations
        api_response = await api_instance.delete_associations(account=account, cluster=cluster, default_qos=default_qos, include_deleted_associations=include_deleted_associations, include_usage=include_usage, filter_to_only_defaults=filter_to_only_defaults, include_the_raw_qos_or_delta_qos=include_the_raw_qos_or_delta_qos, include_sub_acct_information=include_sub_acct_information, exclude_parent_id_name=exclude_parent_id_name, exclude_limits_from_parents=exclude_limits_from_parents, format=format, id=id, parent_account=parent_account, partition=partition, qos=qos, usage_end=usage_end, usage_start=usage_start, user=user)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_clusters_removed_resp import OpenAPIClustersRemovedResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_slurmdbd_qos_removed_resp import OpenAPISlurmdbdQosRemovedResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_wckey_removed_resp import OpenAPIWckeyRemovedResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_accounts_resp import OpenAPIAccountsResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
# **get_accounts**
> OpenAPIAccountsResp get_accounts(description=description, deleted=deleted, with_associations=with_associations, with_coordinators=with_coordinators, no_users_are_coords=no_users_are_coords, users_are_coords=users_are_coords)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get account list
        api_response = await api_instance.get_accounts(description=description, deleted=deleted, with_associations=with_associations, with_coordinators=with_coordinators, no_users_are_coords=no_users_are_coords, users_are_coords=users_are_coords)
...
# **get_association**
> OpenAPIAssocsResp get_association(account=account, cluster=cluster, default_qos=default_qos, include_deleted_associations=include_deleted_associations, include_usage=include_usage, filter_to_only_defaults=filter_to_only_defaults, include_the_raw_qos_or_delta_qos=include_the_raw_qos_or_delta_qos, include_sub_acct_information=include_sub_acct_information, exclude_parent_id_name=exclude_parent_id_name, exclude_limits_from_parents=exclude_limits_from_parents, format=format, id=id, parent_account=parent_account, partition=partition, qos=qos, usage_end=usage_end, usage_start=usage_start, user=user)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_assocs_resp import OpenAPIAssocsResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get association list
        api_response = await api_instance.get_associations(account=account, cluster=cluster, default_qos=default_qos, include_deleted_associations=include_deleted_associations, include_usage=include_usage, filter_to_only_defaults=filter_to_only_defaults, include_the_raw_qos_or_delta_qos=include_the_raw_qos_or_delta_qos, include_sub_acct_information=include_sub_acct_information, exclude_parent_id_name=exclude_parent_id_name, exclude_limits_from_parents=exclude_limits_from_parents, format=format, id=id, parent_account=parent_account, partition=partition, qos=qos, usage_end=usage_end, usage_start=usage_start, user=user)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_clusters_resp import OpenAPIClustersResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_slurmdbd_config_resp import OpenAPISlurmdbdConfigResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_slurmdbd_stats_resp import OpenAPISlurmdbdStatsResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_instances_resp import OpenAPIInstancesResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_slurmdbd_jobs_resp import OpenAPISlurmdbdJobsResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get job list
        api_response = await api_instance.get_jobs(account=account, association=association, cluster=cluster, constraints=constraints, scheduler_unset=scheduler_unset, scheduled_on_submit=scheduled_on_submit, scheduled_by_main=scheduled_by_main, scheduled_by_backfill=scheduled_by_backfill, job_started=job_started, exit_code=exit_code, show_duplicates=show_duplicates, skip_steps=skip_steps, disable_truncate_usage_time=disable_truncate_usage_time, whole_hetjob=whole_hetjob, disable_whole_hetjob=disable_whole_hetjob, disable_wait_for_result=disable_wait_for_result, usage_time_as_submit_time=usage_time_as_submit_time, show_batch_script=show_batch_script, show_job_environment=show_job_environment, format=format, groups=groups, job_name=job_name, partition=partition, qos=qos, reason=reason, reservation=reservation, reservation_id=reservation_id, state=state, step=step, end_time=end_time, start_time=start_time, node=node, users=users, wckey=wckey)
...
# **get_ping**
> OpenAPISlurmdbdPingResp get_ping()
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_slurmdbd_ping_resp import OpenAPISlurmdbdPingResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SlurmdbApi->get_ping:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SlurmdbApi->get_ping: %s\n" % e)
```
...
[**OpenAPISlurmdbdPingResp**](OpenAPISlurmdbdPingResp.md)
...
# **get_qos**
> OpenAPISlurmdbdQosResp get_qos(description=description, include_deleted_qos=include_deleted_qos, id=id, format=format, name=name, preempt_mode=preempt_mode)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_slurmdbd_qos_resp import OpenAPISlurmdbdQosResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get QOS list
        api_response = await api_instance.get_qos(description=description, include_deleted_qos=include_deleted_qos, id=id, format=format, name=name, preempt_mode=preempt_mode)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_tres_resp import OpenAPITresResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_users_resp import OpenAPIUsersResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_wckey_resp import OpenAPIWckeyResp
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    open_api_accounts_resp = slurpy.v0042.asyncio.OpenAPIAccountsResp() # OpenAPIAccountsResp | Description of accounts to update/create (optional)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_accounts_add_cond_resp import OpenAPIAccountsAddCondResp
from slurpy.v0042.asyncio.models.open_api_accounts_add_cond_resp_str import OpenAPIAccountsAddCondRespStr
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    open_api_accounts_add_cond_resp = slurpy.v0042.asyncio.OpenAPIAccountsAddCondResp() # OpenAPIAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    open_api_assocs_resp = slurpy.v0042.asyncio.OpenAPIAssocsResp() # OpenAPIAssocsResp | Job description (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Query reservations updated more recently than this time (UNIX timestamp) (optional)
    open_api_clusters_resp = slurpy.v0042.asyncio.OpenAPIClustersResp() # OpenAPIClustersResp | Cluster add or update descriptions (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    open_api_slurmdbd_config_resp = slurpy.v0042.asyncio.OpenAPISlurmdbdConfigResp() # OpenAPISlurmdbdConfigResp | Add or update config (optional)
...
# **post_qos**
> OpenAPIResp post_qos(description=description, include_deleted_qos=include_deleted_qos, id=id, format=format, name=name, preempt_mode=preempt_mode, open_api_slurmdbd_qos_resp=open_api_slurmdbd_qos_resp)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | CSV QOS name list (optional)
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    open_api_slurmdbd_qos_resp = slurpy.v0042.asyncio.OpenAPISlurmdbdQosResp() # OpenAPISlurmdbdQosResp | Description of QOS to add or update (optional)

    try:
        # Add or update QOSs
        api_response = await api_instance.post_qos(description=description, include_deleted_qos=include_deleted_qos, id=id, format=format, name=name, preempt_mode=preempt_mode, open_api_slurmdbd_qos_resp=open_api_slurmdbd_qos_resp)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    open_api_tres_resp = slurpy.v0042.asyncio.OpenAPITresResp() # OpenAPITresResp | TRES descriptions. Only works in developer mode. (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = slurpy.v0042.asyncio.SlurmdbApi(api_client)
    open_api_users_resp = slurpy.v0042.asyncio.OpenAPIUsersResp() # OpenAPIUsersResp | add or update user (optional)
...
```python
import slurpy.v0042.asyncio
from slurpy.v0042.asyncio.models.open_api_users_add_cond_resp import OpenAPIUsersAddCondResp
from slurpy.v0042.asyncio.models.open_api_users_add_cond_resp_str import OpenAPIUsersAddCondRespStr
from slurpy.v0042.asyncio.rest import ApiException
from pprint import pprint
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    flags = 'flags_example' # str | Query flags (optional)
    open_api_users_add_cond_resp = slurpy.v0042.asyncio.OpenAPIUsersAddCondResp() # OpenAPIUsersAddCondResp | Create users with conditional association (optional)
...
async with slurpy.v0042.asyncio.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted WCKeys (optional)
    open_api_wckey_resp = slurpy.v0042.asyncio.OpenAPIWckeyResp() # OpenAPIWckeyResp | wckeys description (optional)
