"""
Integration tests for Slurm API v0042 (sync version).
"""
...
def api_client(slurm_config: Dict[str, Any]):
    """Create an authenticated API client for v0042."""
...
class TestSlurmV0042:
    """Integration tests for Slurm REST API v0042 (sync)."""

    def test_ping_cluster(self, api_client: slurpy.SlurmApi):
    ...
    def test_list_jobs(self, api_client: slurpy.SlurmApi):
        """Test listing jobs."""
        try:
    ...
    def test_create_job(self, api_client: slurpy.SlurmApi, sample_job: Dict[str, Any]):
        """Test creating a job."""
    ...
    def test_delete_job(self, api_client: slurpy.SlurmApi, sample_job: Dict[str, Any]):
